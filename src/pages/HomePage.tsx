...
const HomePage: React.FC = () => {
  const renderButtons = () => {
    const names = ["Anooshkha", "Jennifer", "Person3", "Person4", "Person5", "Person6", "Person7", "Person8", "Person9", "Person10", "Person11"];
  ...
  return (
    <div id="app-wrapper">
      <header id="header">
        <h1>Welcome to the Spring 2024 React Team page!</h1>
      </header>
